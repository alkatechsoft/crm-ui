<template>
  <b-container fluid class="mt-2">
    ...
    <b-card>
      ...
      >
        <!-- id : {{infoModal.modelData.id }}
        template id : {{templateSelected }}
        title:{{campaignTitle}}
        userArray:{{infoModal.modelData.userArray}}
    ...
    <b-col>
        ...
        <b-col v-if="scheduleNow">
         <hr>
     <b-row cols="2" cla ss="mb-2">
    <b-col lg="6" sm="6">
      <b-form-group>
        <b-form-checkbox @change="repeatSchedule" switch size="lg">Repeat</b-form-checkbox>
      </b-form-group>
    </b-col>
    
   
      <b-col lg="6" sm="6" class="ss-label " v-if="scheduleRepeat">
      <b-form-group>

      <input type="radio" id="cat" name="repeat1"  @change="monthly" value="on" />
      <label for="cat">Monthly</label>
      <input type="radio" id="dog"  name="repeat1" @change="weekly" value="on" />
      <label for="dog">Weekly</label>
      <input type="radio" id="pig" name="repeat1" @change="yearly" value="on" />
      <label for="pig">yearly</label>
      </b-form-group>
...
// function timeFormating( date = new Date) {
...
//   return getTime;
// }
// console.log('time 24 formate', timeFormating());
