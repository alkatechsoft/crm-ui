    ...
    <img alt="ethancoder logo" src="./../../assets/alkatech.png">
        ...
        <b-form @submit="onSubmit" @reset="onReset" v-if="show" class="mt-2">
          <b-form-group id="input-group-1" label-for="input-1">
              ...
              <b-form-input  class="input-field" id="input-1" v-model="form.email" type="email" placeholder="Enter email" required></b-form-input>
              </div>
          </b-form-group>
          ...
          <b-form-group id="input-group-2"   label-for="input-2">
              <div class="input-container">
                ...
                <b-form-input class="input-field" id="input-2" v-model="form.password" type="password" placeholder="Enter password" required></b-form-input>
              </div>
          </b-form-group>
